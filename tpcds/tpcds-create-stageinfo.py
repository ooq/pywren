...
def execute_s3_stage(stage_function, tasks):
    ...
    futures = wrenexec.map_sync_with_rate_and_retries(stage_function, tasks, rate=10)
...
pm = [str(parall_1), str(parall_2), str(parall_3)]
filename = mode + '-tpcds-q16-scale' + str(scale) + "-" + "-".join(pm) + "-b" + str(n_buckets) + ".pickle"
pickle.dump(results, open(filename, 'wb'))

stage_infos = {}
stage_infos['1'] = stage1_info[0]
stage_infos['2'] = stage2_info[0]
stage_infos['3'] = stage3_info[0]
stage_infos['4'] = stage4_info[0]
stage_infos['5'] = stage5_info[0]
filename = "stageinfo.pickle"
pickle.dump(stage_infos, open(filename, 'wb'))
