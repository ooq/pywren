...
hostnames = hostnames[:number_of_nodes]
#'''
...
pm = [str(parall_1), str(parall_2), str(parall_3), str(pywren_rate), str(n_nodes), str(attempt_id)]
filename = "redis.cluster-" +  mode + '-tpcds-q16-scale' + str(scale) +  "-".join(pm) + ".pickle"
